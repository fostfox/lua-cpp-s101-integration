...
function LightFlareAndDescription(feature, featurePortrayal, contextParameters, categoryOfLight)
	...
	featurePortrayal:AddInstructions('Rotation:Portrayal,' .. rotation)
	featurePortrayal:AddInstructions('DrawSymbol:' .. symbol)

	featurePortrayal:AddInstructions('Rotation:None;ViewingGroup:23;DrawingPriority:8;FontSize:10;FontColor:CHBLK')

	if rotation == 45 then
		featurePortrayal:AddInstructions('MoveRelativeLocal:7.02,3.51;TextAlignHorizontal:Start;TextAlignVertical:Bottom')
	else
		featurePortrayal:AddInstructions('MoveRelativeLocal:7.02,0;TextAlignHorizontal:Start;TextAlignVertical:Center')
	end
	...
	featurePortrayal:AddInstructions('DrawText:' .. description)
end
