	...
	for curveAssociation in feature:GetFlattenedSpatialAssociations() do
		...
		if loc_safety or unsafe and safe then
			if contextParameters.RADAR_OVERLAY then
				...
				featurePortrayal:AddInstructions('ViewingGroup:13010;DrawingPriority:8;DisplayPlane:UnderRADAR')
			end
			...
			if loc_valdco then
				if contextParameters.RADAR_OVERLAY then
					...
					featurePortrayal:AddInstructions('ViewingGroup:33021;DrawingPriority:8;DisplayPlane:UnderRADAR')
				end
